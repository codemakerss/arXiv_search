...
| :---------------: | :-------: | :----------------------------------------------------------: |
|   search_query    |  string   | words user want to search for<br />note : if you want to search for two words and above, please use this format: `quant+finance` or `web3+blockchain` |
